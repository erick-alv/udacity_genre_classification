...
def go(config: DictConfig):
    ...
    if "preprocess" in steps_to_execute:
        ...
        _ = mlflow.run(
            ...
            "main",
            parameters={
                "input_artifact": f"{project_name}/raw_data.parquet:latest",
    ...
    if "check_data" in steps_to_execute:
        ...
        _ = mlflow.run(
            ...
            parameters={
                ...
                "sample_artifact": f"{project_name}/preprocessed_data.parquet:latest",
    ...
    if "segregate" in steps_to_execute:
        ...
        _ = mlflow.run(
            ...
            "main",
            parameters={
                "input_artifact": f"{project_name}/preprocessed_data.parquet:latest",
                "artifact_root": "data",
                "artifact_type": "splitted data",
    ...
    if "evaluate" in steps_to_execute:
        ...
        model_export_name = config["random_forest_pipeline"]["export_artifact"]
        _ = mlflow.run(
            os.path.join(root_path, "evaluate"),
            "main",
            parameters={
                "model_export": f"{project_name}/{model_export_name}:latest",
